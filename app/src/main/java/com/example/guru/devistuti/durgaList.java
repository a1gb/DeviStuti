...
public class durgaList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_durga_list);
        getSupportActionBar().setTitle("Durga Stuti");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0)
                {
                    ...
                    Intent intent = new Intent(durgaList.this, com.example.guru.devistuti.durga.class);
