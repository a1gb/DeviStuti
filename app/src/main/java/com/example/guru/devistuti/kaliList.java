...
public class kaliList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kali_list);
        getSupportActionBar().setTitle("Kali Stuti");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0)
                {
                    ...
                    Intent intent = new Intent(kaliList.this, com.example.guru.devistuti.kali.class);
