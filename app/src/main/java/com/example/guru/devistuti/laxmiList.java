...
public class laxmiList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laxmi_list);
        getSupportActionBar().setTitle("Laxmi Stuti");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0)
                {
                    ...
                    Intent intent = new Intent(laxmiList.this, com.example.guru.devistuti.laxmi.class);
