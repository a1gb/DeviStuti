...
public class saraswati extends AppCompatActivity {
    Button playDurga;
    TextView lyrics;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Jai Maa Sharada");
        playDurga=(Button)findViewById(R.id.playSaraswati);
         mediaPlayer=MediaPlayer.create(this,R.raw.yakundendu);
        lyrics=(TextView)findViewById(R.id.sl);
